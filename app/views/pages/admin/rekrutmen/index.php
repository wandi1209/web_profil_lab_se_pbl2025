        ...
        <table class="table table-bordered align-middle">
            ...
            <?php if (!empty($dataRekrutmen)): ?>
                ...
                <tr>
                    ...
                    <td>
                        <a href="/admin/profile/rekrutmen/index/edit?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="/admin/profile/rekrutmen/index/delete?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php else: ?>
